...
//     public Map<String, List<Tuple<Long, Int>>> splitData(Map<String, List<TaskProvenance>> processProvenanceMap) {

//         Map<String, List<Tuple<Long, Int>>> processKeyedDataSets = new HashMap<>();
...
//             List<Tuple<Double, Double>> allData = new ArrayList<>();
...
//             List<Tuple<Long, Int>> trainingData = new ArrayList<>(allData.subList(0, splitIndex));
