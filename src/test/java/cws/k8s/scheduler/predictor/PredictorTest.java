...
//         Map<String, List<Tuple<Double, Double>>> processData = new HashMap<>();
//         processData.put("Process1", Arrays.asList(new Tuple<>(1.0, 2.0), new Tuple<>(2.0, 4.0)));
//         processData.put("Process2", Arrays.asList(new Tuple<>(1.0, 3.0), new Tuple<>(2.0, 6.0)));
